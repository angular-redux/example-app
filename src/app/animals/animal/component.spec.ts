...
describe('AnimalComponent', () => {
  ...
  it(
    'select name data from the substore',
    async(() => {
  ...
  it(
    'select ticket price data from the substore',
    async(() => {
      const mockSubStore = MockNgRedux.getSubStore([
        'WALLABIES',
        'items',
  ...
  it(
    'select ticket quantity data from the substore',
    async(() => {
      const mockSubStore = MockNgRedux.getSubStore([
        'WALLABIES',
        'items',
  ...
  it(
    'should use reasonable defaults if ticket price is missing',
    async(() => {
      animalComponent.ticketPrice$.subscribe(ticketPrice =>
  ...
  it(
    'should use reasonable defaults if ticket quantity is missing',
    async(() => {
      animalComponent.numTickets$.subscribe(numTickets =>
  ...
  it(
    'should compute the subtotal as the ticket quantity changes',
    async(() => {
      const mockSubStore = MockNgRedux.getSubStore([
        'WALLABIES',
        'items',
